...
(0, _jquery2.default)(function () {
    ...
    ptBarrio.hover(function () {
        (0, _jquery2.default)('#mapaPanama').append((0, _jquery2.default)('<img src="imagenes/ventana.png" alt="Barrio de Soneros" class="ventana">'));
    }, function () {
        (0, _jquery2.default)('#mapaPanama').find('.ventana').remove();
    });
    //    var ptFlamboyan = $('#ptFlamboyan')

    //    ptFlamboyan.click(alert('hola'))
    //Click
    (0, _page2.default)('/barrio', function (ctx, next) {
